 ...
 * Generated at: 2024-11-19 16:20:28 UTC
...
public final class joinRoom_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    if (userId != null && roomId != null) {
        ...
        try {
            ...
            String checkUserRoomSql = "SELECT room_id FROM users WHERE id = ?"; // 'id'로 수정
            ...
            // 이미 방에 입장했다면 방에 입장할 수 없도록 처리
            if (userRoomId == null) {
                // 방에 사용자가 없으면, users 테이블에 추가
                String insertSql = "INSERT INTO users (id, room_id) VALUES (?, ?)"; // 'user_id' -> 'id'
                pstmt = conn.prepareStatement(insertSql);
                pstmt.setString(1, userId); // 'userId'를 'id' 컬럼에 넣음
